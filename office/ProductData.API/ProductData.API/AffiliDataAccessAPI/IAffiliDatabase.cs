...
{
    /// <summary>
    /// Determines common behaviour for all DB acess implementations. 
    /// Change History: Version;Date;Changed by;Change description
    /// 1.0;15-Feb-2009;Ajit Chahal;-
    /// </summary>
    public interface IAffiliDatabase
    {
        ...
        /// One needs to set it to false to use retrieve data through same instance of IAffiliDatabase.
        /// </summary>
