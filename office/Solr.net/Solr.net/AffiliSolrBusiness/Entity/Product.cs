...
namespace AffiliSolrBusiness.Entity
{
    public class Product : IDisposable
    {
        ...
        //    if (dtProduct == null)
        //    {
        //        dtProduct = new ProductDao().GetProductSchema();//todo dont go to db every time check in csv processor code
        //    }
        //    productRow = dtProduct.NewRow();
        //    Initialize(dtProduct, 0, false);
        //}
