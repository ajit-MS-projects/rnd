...
namespace JsonNetMessageFormatter
{
    ...
    public class Person
    {
        ...
        public int Id;
        [DataMember(Order = 6), Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter)), Newtonsoft.Json.JsonProperty]
       ...
       /* public override string ToString()
        {
            ...
            sb.Append("Person[");
            sb.AppendFormat(
                "FirstName1={0},LastName={1},BirthDate={2},Id={3},Pets",
                this.FirstName,
                this.LastName,
