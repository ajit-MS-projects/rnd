...
namespace Solar.Common
{
    public static class Utilities
    {
        ...
        public static void CreateStartLog(String message)
        {
            CreateStartLog(StartString + message, ApplicationEventsEnum.None);
        }
        /// <summary>
        /// Method logs a debug log designating start of an operation
        /// </summary>
        ...
        /// <param name="message"></param>
        /// <param name="eventId"></param>
        public static void CreateEndLog(String message )
        {
            CreateEndLog(EndString + message, ApplicationEventsEnum.None);
        }
        /// <summary>
        /// Method logs a debug log designating end of an operation
        /// </summary>
        ...
        {
            CreateInfoLog(message, ApplicationEventsEnum.None);
        }
        /// <summary>
        /// Method logs an information log 
        /// </summary>
        ...
        {
            CreateEmailLog(message, ApplicationEventsEnum.None);
        }
        /// <summary>
        /// Method sends an email of information log 
        /// </summary>
        /// <param name="message"></param>
        public static void CreateEmailLog(String message, ApplicationEventsEnum eventId)
        {
            CreateLog(message, eventId, LoggingCategoriesEnum.Email);
        }
        /// <summary>
        ...
        /// <summary>
        /// Method instantiate log objects and sends log requests
        /// </summary>
        /// <param name="message"></param>
        /// <param name="eventId"></param>
        ...
        public static void CreateDatabaseLog(List<DatabaseLog> log)
        {
            BaseLogger objLogger = new GenericLogger();
            objLogger.CreateDatabaseLog(log);
        }
        ...
        /// Pad any character in front of string
        /// </summary>
        /// <param name="strValue">String to pad</param>
        /// <returns></returns>
        public static string PadString(this string strValue, char padCharater,int length)
        {
            return (strValue.Length < length) ? strValue.PadLeft(length, padCharater) : strValue;
        }
