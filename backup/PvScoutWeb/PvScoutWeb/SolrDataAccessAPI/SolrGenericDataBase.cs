...
namespace Solr.Data.Access
{
    ...
    /// </summary>
    public class SolrGenericDataBase : ISolrDatabase
    {
        ...
        /// <summary>
        /// Is set to true automatically if multiple comaands are set up, one needs to set to false to use single command on same instance of SolrGenericDataBase.
        /// </summary>
       ...
       /// </summary>
       /// <param name="dbConnectionStringId">Enum representing one of Solr Databases.</param>
        public SolrGenericDataBase(DatabaseConnectionsEnum dbConnectionStringId)
        {
        ...
        private string GetDB_Connection(DatabaseConnectionsEnum dbConnect)
        {
            switch (dbConnect)
            {
                ...
                case DatabaseConnectionsEnum.Solr:default:
                    return Constants.DBConnections.Solr;
            }
        }
