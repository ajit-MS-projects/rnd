...
namespace org.apache.solr.SolrSharp.Configuration.Schema
{
    ...
    {
        private SolrField sourceField = null;
        private SolrField destinationField = null;
        ...
        public SolrCopyField(XmlNode xnCopyField, SolrField[] solrFields)
        {
        ...
        /// </summary>
        public SolrField DestinationField
        {
