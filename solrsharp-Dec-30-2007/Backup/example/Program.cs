    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ***************************************************************/
            ...
            if (solrSearcher.SolrSchema.IsValidUpdateIndexDocument(iDoc))
            {
            ...
            ***************************************************************/
            HighlightParameterCollection highlightParameterCollection =
                new HighlightParameterCollection();
            ...
            ***************************************************************/
            highlightParameterCollection.Snippets = 3;
            ...
            ***************************************************************/
            ...
            List<QueryParameter> otherListQp = new List<QueryParameter>();
            otherListQp.Add(new QueryParameter("cat", "Computer"));
            ...
            foreach (KeyValuePair<string, int> kvp in searchResults.ExampleCategoryFacetResults.Facets)
            {
                Console.WriteLine(string.Format("Cat = {0}: count = {1}", kvp.Key, kvp.Value));
            }
