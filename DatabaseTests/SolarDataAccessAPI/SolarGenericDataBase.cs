...
namespace Solar.Data.Access
{
    ...
    /// </summary>
    public class SolarGenericDataBase : ISolarDatabase
    {
       ...
       /// <param name="dbConnectionStringId">Enum representing one of Solar Databases.</param>
        public SolarGenericDataBase(DatabaseConnectionsEnum dbConnectionStringId)
        {
        ...
        private string GetDB_Connection(DatabaseConnectionsEnum dbConnect)
        {
            switch (dbConnect)
            {
                ...
                case DatabaseConnectionsEnum.PvScout:default:
