<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MvcAndMobileDeviceDetection.Mobile.Default" %>
...
<body>
    ...
    <div>
        ...
        <ul>
            ...
            <li>Viewport: <% =Request.Browser["Platform"] %></li>
        </ul>
